...
module Verse
  module Util
    ...
    module DistributedLock
      ...
      # @raise [Verse::Util::Errors::LockError] for unexpected errors during acquisition.
      ...
      # @raise [Verse::Util::Errors::LockReleaseError] for critical errors during release.
      ...
      # @raise [Verse::Util::Errors::LockRenewalError] for critical errors during renewal.
      ...
      # @raise [Verse::Util::Errors::LockAcquisitionTimeoutError] if the lock cannot be acquired within the timeout.
      ...
      def with_lock(lock_key, requested_ttl_ms, acquire_timeout_ms)
        ...
        unless token
          raise Errors::LockAcquisitionTimeoutError, "Failed to acquire lock '#{lock_key}' within #{acquire_timeout_ms}ms."
        end
